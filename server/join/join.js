...
function joinRoom() {
    const value = eval(document.getElementById('input').value);
...
timer = setInterval(() => {
    ...
    drawenemyrock();
        ...
        c.fillStyle = 'white';
        c.fillText("Join A Match!", 180, 200);
    }
...
function removeContent() {
    if(remove) {
        ...
        document.getElementById('title').innerHTML = 'Stick Man 1v1'
    }
}
